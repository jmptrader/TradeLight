...
Crafty['import'] = function (obj, scene) {
    //if its a string, load the lib file
    if (typeof obj === "string") {
        if (levelData) {
            ...
            var elem;
            elem = document.createElement("lib");
...
Crafty.extend({
    ...
    modules: function (modulesRepository, moduleMap, oncomplete) {
        ...
        /*!
         * $lib.js Async loader & dependency manager
         * https://github.com/ded/lib.js
